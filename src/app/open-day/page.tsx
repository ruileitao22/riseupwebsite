...
export const metadata: Metadata = { title: "Inscrição — Open Day Rise Up", description: "Conhece a Rise Up no dia 18 de setembro, das 9h30 às 18h. Inscrições até 17 de setembro, às 15h00.", alternates: { canonical: "/open-day" } };
