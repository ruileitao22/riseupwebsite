(function () {
  ...
  const canAssign = () => currentRole() === "admin" || currentRole().startsWith("team_leader");
  const canManageHr = () => ["admin", "hr_team", "team_leader_hr"].includes(currentRole());
  ...
  function renderDrive() {
    ...
    const canDelete = workspace.drive.permissions.delete && currentRole() === "admin";
