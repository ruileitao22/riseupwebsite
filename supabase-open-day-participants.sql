-- Allow students, Rise Up Legends and external participants in Open Day registrations.
...
alter table public.open_day_registrations
  ...
  add constraint open_day_registrations_participant_type_check check (participant_type in ('student', 'legend', 'external')),
